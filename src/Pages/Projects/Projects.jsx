    ...
    return (
        <div className="mx-auto flex flex-col items-center py-16 px-10 animate__animated animate__fadeInUp" id="projects">
            ...
            <div className='w-full lg:w-10/12 mx-auto space-y-10'>
                ...
                {/* project 3 */}
                <div className="flex flex-col md:flex-row items-start gap-10 p-5 rounded-xl shadow-custom">
                    <img className="w-full md:w-1/2 shadow-md rounded-lg" src={web3} alt="web page 1" />
                    <div className="w-full md:w-1/2 space-y-5">
